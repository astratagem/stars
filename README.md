...
- [pdanzma/kage-css](https://github.com/pdanzma/kage-css) - This custom CSS theme significantly enhances the user experience of the "Kagi" search engine by incorporating glassmorphism visuals, modern animations and customisable colour options.
- [jcrabapple/kagi-catppuccin-light-dark](https://github.com/jcrabapple/kagi-catppuccin-light-dark) - Catppuccin Mocha custom CSS for Kagi.com
...
- [alizehctl/firefox-i3wm-theme](https://github.com/alizehctl/firefox-i3wm-theme) - i3 and qutebrowser inspired theme for firefox
...
- [WordPress/library](https://github.com/WordPress/library) - Our book about WordPress. Volume 1, first ten years
...
- [a8cteam51/special-projects-blocks-monorepo](https://github.com/a8cteam51/special-projects-blocks-monorepo) - Monorepo of custom Gutenberg blocks by the WordPress.com Special Projects team, including dynamic TOC, mega menu, modal, tabs, reactions, scroll progress, light-dark toggle, and more. An autoloader pl
...
- [spaze/phpstan-disallowed-calls](https://github.com/spaze/phpstan-disallowed-calls) - PHPStan rules to detect disallowed method & function calls, constant, namespace, attribute, keyword & superglobal usages, with powerful rules to re-allow a call or a usage in places where it should be
...
- [johnbillion/user-switching](https://github.com/johnbillion/user-switching) - Instant switching between user accounts in WordPress and WooCommerce.
- [johnbillion/wp-crontrol](https://github.com/johnbillion/wp-crontrol) - Take control of the cron events on your WordPress website or WooCommerce store
...
- [Mopolo/MagicConstant](https://github.com/Mopolo/MagicConstant) - PHP Magic Constants, even more powerful than an Enum
...
- [termworks/lule](https://github.com/termworks/lule) - ANSI color generator for your terminal
...
- [ai/env](https://github.com/ai/env) - My home config, scripts and installation process
...
- [yuschick/stylelint-plugin-defensive-css](https://github.com/yuschick/stylelint-plugin-defensive-css) - A Stylelint plugin to help you write more defensive, accessible, and maintainable CSS
...
- [Aperocky/cellular-automata](https://github.com/Aperocky/cellular-automata) - Define your own cellular automata in browser.
